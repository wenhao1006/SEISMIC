      ...
      (loop  ;; label = @2
        ...
        (br_if 0 (;@2;)
          (i32.ne
            ...
            (i32.const 8))))
      (i32.const 0)))
  (func $_blake2b_zcash (type 7) (param i32 i32 i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i64 i64 i64 i64 i64 i64 i64 i64 i64)
    (block  ;; label = @1
      (set_local 34
        (get_global 6))
      (set_global 6
