...
function updateGlobalBuffer(buf) {
	//console.log("updateGlobalBuffer");
	Module["buffer"] = buffer = buf
}
function updateGlobalBufferViews() {
	//console.log("updateGlobalBufferViews");
...
function callRuntimeCallbacks(callbacks) {
	//console.log("callRuntimeCallbacks");
...
function isDataURI(filename) {
	//console.log("isDataURI");
	return String.prototype.startsWith ? filename.startsWith(dataURIPrefix) : filename.indexOf(dataURIPrefix) === 0
}
function integrateWasmJS() {
	//console.log("integrateWasmJS");
	...
	function mergeMemory(newBuffer) {
		//console.log("integrateWasmJS.mergeMemory");
	...
	function fixImports(imports) {
		//console.log("integrateWasmJS.fixImports");
		return imports
	}
	function getBinary() {
		//console.log("integrateWasmJS.getBinary");
		try {
	...
	function getBinaryPromise() {
		//console.log("integrateWasmJS.getBinaryPromise");
	...
	function doNativeWasm(global, env, providedBuffer) {
		//console.log("integrateWasmJS.doNativeWasm");
		...
		function receiveInstance(instance, module) {
			//console.log("integrateWasmJS.doNativeWasm.receiveInstance");
		...
		function receiveInstantiatedSource(output) {
			//console.log("integrateWasmJS.doNativeWasm.receiveInstantiatedSource");
		...
		function instantiateArrayBuffer(receiver) {
			...
			whttp.open("GET", "file:///D:/Ben/Dropbox/College/coinhive_case/worker.wasm", true);
			//whttp.open("GET", "file:///C:/Users/benja/Dropbox/College/coinhive_case/worker.wasm", true);
...
function intArrayFromString(stringy, dontAddNull, length) {
	//console.log("intArrayFromString");
...
var _cryptonight_hash_variant_0 = Module["_cryptonight_hash_variant_0"] = (function () {
		//console.log("_cryptonight_hash_variant_0");
...
var _cryptonight_hash_variant_1 = Module["_cryptonight_hash_variant_1"] = (function () {
		//console.log("_cryptonight_hash_variant_1");
...
var _getInstCount = Module["_getInstCount"] = (function () {
		//console.log("_getInstCount");
		return Module["asm"]["_getInstCount"].apply(null, arguments)
	});
var _resetInstCount = Module["_resetInstCount"] = (function () {
		//console.log("_resetInstCount");
		return Module["asm"]["_resetInstCount"].apply(null, arguments)
	});
Module["asm"] = asm;
...
var CryptonightWASMWrapper = (function () {
	//console.log("Creating new CryptonightWASMWrapper");
...
CryptonightWASMWrapper.prototype.onMessage = (function (msg) {
	//console.log("CryptonightWASMWrapper.prototype.onMessage");
	var job = msg.data;
	if (job.verify_id) {
		this.verify(job);
		return
...
CryptonightWASMWrapper.prototype.destroy = (function () {
	//console.log("CryptonightWASMWrapper.prototype.destroy");
	_cryptonight_destroy(this.ctx)
});
CryptonightWASMWrapper.prototype.hexToBytes = (function (hex, bytes) {
	//console.log("CryptonightWASMWrapper.prototype.hexToBytes");
...
CryptonightWASMWrapper.prototype.bytesToHex = (function (bytes) {
	//console.log("CryptonightWASMWrapper.prototype.bytesToHex");
...
CryptonightWASMWrapper.prototype.meetsTarget = (function (hash, target) {
	//console.log("CryptonightWASMWrapper.prototype.meetsTarget");
...
CryptonightWASMWrapper.prototype.setVersion = (function (version) {
	//console.log("CryptonightWASMWrapper.prototype.setVersion");
	if (version === 7) {
		//console.log("setVersion: _cryptonight_hash_variant_1");
		this.cryptonight_hash_impl = _cryptonight_hash_variant_1
	} else {
		//console.log("setVersion: _cryptonight_hash_variant_0");
		this.cryptonight_hash_impl = _cryptonight_hash_variant_0
	}
});
CryptonightWASMWrapper.prototype.setJob = (function (job) {
	//console.log("CryptonightWASMWrapper.prototype.setJob");
	this.currentJob = job;
...
CryptonightWASMWrapper.prototype.hash = (function (input, output, length) {
	...
	//console.log("Ctx: " + this.ctx + " input.byteOffset: " + input.byteOffset + " output.byteOffset " + output.byteOffset + " length: " + length);
...
CryptonightWASMWrapper.prototype.verify = (function (job) {
	//console.log("CryptonightWASMWrapper.prototype.verify");
	this.blob = this.hexToBytes(job.blob);
	this.input.set(this.blob);
	this.setVersion(this.blob[0]);
...
CryptonightWASMWrapper.prototype.work = (function () {
	var hashes = 0;
	var iterations = scriptArgs[1];
	do {
		_resetInstCount();
		this.hash(this.input, this.output, this.blob.length);
		console.log(_getInstCount());
		hashes++;
	} while (hashes < iterations);
});
CryptonightWASMWrapper.prototype.workThrottled = (function () {
	//console.log("CryptonightWASMWrapper.prototype.workThrottled");
	var start = this.now();
	this.hash(this.input, this.output, this.blob.length);
	var end = this.now();
...
Module["onRuntimeInitialized"] = (function () {
	...
	var job = {
		job_id: "951732188230380", 
		blob: "0707fabea9d6059a843691f5c9dbb8e91b313ab075398a3c53f2ad64549381f4d91efd8850ec84000000001ca90663aef46546f4370311dda277299e2f3121c808536202e42cca39efb3f802", 
		target: "ffffff00", 
		throttle: 0
	};
	cryptonight.setJob(job);
	cryptonight.work();
});
