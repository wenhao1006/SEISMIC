(module
  ...
  (func $stackAlloc (type 5) (param $p0 i32) (result i32)
    ...
    (set_global 4
      (i32.and
        ...
        (i32.const -16)))
    (get_local $l0))
  (func $_getInstCount (type 9) (result i64) (return (get_global 5)))
  (func $_resetInstCount (type 1) (set_global 5 (i64.const 0)))
  ...
  (export "_getInstCount" (func $_getInstCount))
  (export "_resetInstCount" (func $_resetInstCount))
