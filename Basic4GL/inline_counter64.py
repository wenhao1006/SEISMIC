...
inlineAdd = " (set_global 18 (i64.add (get_global 18) (i64.const 1)))"
inlineAnd = " (set_global 19 (i64.add (get_global 19) (i64.const 1)))"
inlineShl = " (set_global 20 (i64.add (get_global 20) (i64.const 1)))"
inlineShr = " (set_global 21 (i64.add (get_global 21) (i64.const 1)))"
inlineXor = " (set_global 22 (i64.add (get_global 22) (i64.const 1)))"
