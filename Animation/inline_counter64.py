...
inlineAdd = " (set_global 4 (i64.add (get_global 4) (i64.const 1)))"
inlineAnd = " (set_global 5 (i64.add (get_global 5) (i64.const 1)))"
inlineShl = " (set_global 6 (i64.add (get_global 6) (i64.const 1)))"
inlineShr = " (set_global 7 (i64.add (get_global 7) (i64.const 1)))"
inlineXor = " (set_global 8 (i64.add (get_global 8) (i64.const 1)))"
