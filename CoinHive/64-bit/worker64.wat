(module
  ...
  (func $stackAlloc (type 5) (param $p0 i32) (result i32)
    ...
    (set_global 4
      (i32.and
        ...
        (i32.const -16)))
    (get_local $l0))
  (func $_getI32AddCountLo (type 2) (result i32) 
    (return (i32.wrap/i64 (get_global 5))))
  (func $_getI32AndCountLo (type 2) (result i32)
    (return (i32.wrap/i64 (get_global 6))))
  (func $_getI32ShlCountLo (type 2) (result i32)
    (return (i32.wrap/i64 (get_global 7))))
  (func $_getI32ShruCountLo (type 2) (result i32)
    (return (i32.wrap/i64 (get_global 8))))
  (func $_getI32XorCountLo (type 2) (result i32)
    (return (i32.wrap/i64 (get_global 9))))
  (func $_getI32AddCountHi (type 2) (result i32)
    (return (i32.wrap/i64 (i64.div_s (get_global 5) (i64.const 4294967296)))))
  (func $_getI32AndCountHi (type 2) (result i32)
    (return (i32.wrap/i64 (i64.div_s (get_global 6) (i64.const 4294967296)))))
  (func $_getI32ShlCountHi (type 2) (result i32) 
    (return (i32.wrap/i64 (i64.div_s (get_global 7) (i64.const 4294967296)))))
  (func $_getI32ShruCountHi (type 2) (result i32) 
    (return (i32.wrap/i64 (i64.div_s (get_global 8) (i64.const 4294967296)))))
  (func $_getI32XorCountHi (type 2) (result i32) 
    (return (i32.wrap/i64 (i64.div_s (get_global 9) (i64.const 4294967296)))))
  (func $_resetInstCounters (type 1) 
    (set_global 5 (i64.const 0))
	(set_global 6 (i64.const 0))
	(set_global 7 (i64.const 0))
	(set_global 8 (i64.const 0))
	(set_global 9 (i64.const 0)))
  ...
  (elem (get_global 0) $f19 $f34 $f30 $f33 $f32 $f19 $f19 $f19)
