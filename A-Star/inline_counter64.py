...
inlineAdd = " (set_global 0 (i64.add (get_global 0) (i64.const 1)))"
inlineAnd = " (set_global 1 (i64.add (get_global 1) (i64.const 1)))"
inlineShl = " (set_global 2 (i64.add (get_global 2) (i64.const 1)))"
inlineShr = " (set_global 3 (i64.add (get_global 3) (i64.const 1)))"
inlineXor = " (set_global 4 (i64.add (get_global 4) (i64.const 1)))"
