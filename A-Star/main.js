const WASM_ASTAR = {
  wasmModule: null,
  wasmModulePath: 'wasm_astar_base_profiled.wasm',
...
function wasmProfiler() {
	if (WASM_ASTAR.wasmModule != null && typeof WASM_ASTAR.wasmModule._resetInstCounters === "function") {
		...
		addCountLo[0] = WASM_ASTAR.wasmModule._getI32AddCountLo();
		andCountLo[0] = WASM_ASTAR.wasmModule._getI32AndCountLo();
		shlCountLo[0] = WASM_ASTAR.wasmModule._getI32ShlCountLo();
		shrCountLo[0] = WASM_ASTAR.wasmModule._getI32ShruCountLo();
		xorCountLo[0] = WASM_ASTAR.wasmModule._getI32XorCountLo();
		addCountHi[0] = WASM_ASTAR.wasmModule._getI32AddCountHi();
		andCountHi[0] = WASM_ASTAR.wasmModule._getI32AndCountHi();
		shlCountHi[0] = WASM_ASTAR.wasmModule._getI32ShlCountHi();
		shrCountHi[0] = WASM_ASTAR.wasmModule._getI32ShruCountHi();
		xorCountHi[0] = WASM_ASTAR.wasmModule._getI32XorCountHi();
		WASM_ASTAR.wasmModule._resetInstCounters();	
